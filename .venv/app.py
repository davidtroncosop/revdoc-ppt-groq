...
def analyze_image(base64_image, api_key):
    ...
    payload = {
        "model": "llava-v1.5-7b-4096-preview",  # Adjust the model name as per Groq's offerings
        "messages": [
            {
                "role": "user",
                "content": [
...
""" 
        ...
        completion = client.chat.completions.create(
            model="llama3-8b-8192",  # Adjust the model name as per Groq's offerings
            messages=[
        ...
        print(f"Raw Groq response: {respuesta_fila}")
